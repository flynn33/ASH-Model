...
\begin{figure}[H]
\centering
\IfFileExists{../figures/hypercube-3d-projection.png}{%
  \includegraphics[width=0.8\textwidth]{../figures/hypercube-3d-projection.png}%
}{%
  \fbox{\parbox{0.8\textwidth}{\centering Missing image: ../figures/hypercube-3d-projection.png}}%
}
...
\bibitem{fauxgates2005}
M. Faux and S. J. Gates Jr., ``Adinkras: A graphical technology for supersymmetric representation theory,'' Int. J. Mod. Phys. A \textbf{15} (2005).

\bibitem{doran2008}
C. Doran, M. Faux, S. J. Gates Jr., T. Hubsch, K. M. Iga and G. D. Landweber, ``On the matter of Adinkras,'' Adv. Theor. Math. Phys. \textbf{13} (2008).

\bibitem{almheiri2015}
A. Almheiri, X. Dong and D. Harlow, ``Bulk locality and quantum error correction in AdS/CFT,'' JHEP \textbf{2015}.

\bibitem{green1984}
M. B. Green and J. H. Schwarz, ``Anomaly cancellations in supersymmetric D=10 gauge theory and superstring theory,'' Phys. Lett. B \textbf{149} (1984).

\bibitem{polchinski1998}
J. Polchinski, ``String Theory,'' Vols. 1–2, Cambridge University Press (1998).

\bibitem{cohnkumar2009}
H. Cohn and A. Kumar, ``Universally optimal distribution of points on spheres,'' J. Amer. Math. Soc. \textbf{20} (2009).

\bibitem{cohn2019}
H. Cohn, ``Recent progress on the sphere packing problem,'' Notices of the AMS \textbf{66} (2019).

\end{thebibliography}

\appendix
\section{Selected Proofs}
Projection idempotence and error bounds.
